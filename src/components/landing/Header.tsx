    ...
    return (
        ...
        >
            <section className="flex justify-center">
                <div className="w-[90%] md:w-[80%] lg:pt-50 pt-30 lg:pb-30 pb-10 grid grid-cols-1 lg:grid-cols-2 items-center z-10 relative rtl">
                    <DotLottieReact
                    ...
                    <div className="flex flex-col items-center w-full lg:w-[80%]">
                        ...
                        <div className="w-full py-10">
                            <PrimaryNavigationButton title={headerContent.button} href="/form" className="w-full" />
                        </div>
                    </div>
                </div>
            </section>
